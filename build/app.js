...
var DataEmblem = function (_React$Component) {
  _inherits(DataEmblem, _React$Component);

  _createClass(DataEmblem, [{
    key: 'loadJSONFromServer',
    value: function loadJSONFromServer() {
      var _this2 = this;
  ...
  function DataEmblem() {
    _classCallCheck(this, DataEmblem);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DataEmblem).call(this));
...
_reactDom2.default.render(_react2.default.createElement(DataEmblem, null), document.getElementById('container'));
